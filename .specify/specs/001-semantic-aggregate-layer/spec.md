...
- Q: Размер каталога агрегатов vs контекст LLM? → A: Двухшаговый planning. Шаг 1 — LLM получает компактный индекс категорий и выбирает нужные. Шаг 2 — LLM получает детальные агрегаты только выбранных категорий. Причина: у клиента много салонов/мастеров, каталог может быть большим; также возможны нестандартные кросс-доменные запросы ("сравни отток и оборот за две недели").
