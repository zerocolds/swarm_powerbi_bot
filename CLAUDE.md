...
- Python 3.11+ + стандартная библиотека (`re`, `datetime`). Функция изолирована, никаких новых пакетов. (012-fix-bare-months)
- N/A (чистая функция парсинга) (012-fix-bare-months)
...
## Recent Changes
- 012-fix-bare-months: Added Python 3.11+ + стандартная библиотека (`re`, `datetime`). Функция изолирована, никаких новых пакетов.
